...
let g:pdv_cfg_Author = "zxj <tenkanse@hotmail.com>"
...
func! PhpDocFunc()
    ...
    exe l:txtBOL . g:pdv_cfg_Commentn1 . g:pdv_cfg_EOL

    "exe l:txtBOL . g:pdv_cfg_Commentn . "@modify_time " . g:pdv_cfg_Version . g:pdv_cfg_EOL
